...
const ContactList = (props) => {
    ...
    return (
        <div className="relative">
            <div className="fixed top-14 left-0 right-0 bg-white z-20 p-4 shadow-md">
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between m-1">
                    <div className="flex items-center justify-between w-full sm:w-auto mb-2 sm:mb-0">
                        <h2 className="text-lg sm:text-xl font-medium text-teal-600">Contact List</h2>
                    ...
                    <div className="flex flex-grow justify-center mb-2 sm:mb-0">
                        <input 
                            ...
                            className="p-2 text-xs sm:text-sm border rounded border-gray-200 w-full sm:w-96 focus:outline-none focus:border-teal-600"
                        />
                    </div>
                    <Link to="/add" className="hidden sm:inline-block sm:ml-4">
                        <button className="p-2 bg-teal-600 text-white rounded hover:bg-teal-700 text-xs sm:text-sm">
                            Add Contact
                        </button>
                    </Link>
                </div>
            </div>
            <div className="pt-28 sm:pt-16">{renderContactList.length > 0 ? renderContactList : "No contacts found"}</div>
        </div>
    );
};
